...
var i18n = {
  ru: {
    ...
    'file_format_desc':'Мета-данные в &lt;meta name=&quot;...&quot; content=&quot;...&quot;&gt; передают настройки коллекции: slug, заголовок, язык, теги, дату публикации, статус доступа, категорию, цену, наличие, описание и системные параметры. Содержимое коллекции — после &lt;!-- РАЗДЕЛИТЕЛЬ СТАТЬЯ НИЖЕ --&gt;',
