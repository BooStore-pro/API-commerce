...
document.getElementById('site_selector').addEventListener('change', function() {
  navigateSite(this.value);
});
// Show links on page load if site already selected
if (document.getElementById('site_selector').value) {
  navigateSite(document.getElementById('site_selector').value);
}
