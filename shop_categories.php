...
$configFile = __DIR__ . '/_setting_shop_categories.inc';
...
$API_URL = 'https://' . $currentSite . '/api/commerce/products/categories';
...
$CATEGORIES_DIR = $SITE_DIR . DIRECTORY_SEPARATOR . 'shop_categories';
...
// ---- Хлебные крошки ----
$crumbs = ['<a href="index.php" style="color:#00d4ff;text-decoration:none;font-weight:600;"><span data-i18n="home">🏠 Главная</span></a>', '<a href="?site='.urlencode($currentSite).'" style="color:#00d4ff;text-decoration:none;font-weight:600;">📝 <span data-i18n="entity_name">Категории</span></a>'];
...
<h1 style="margin:0 0 20px 0;">▸ <span data-i18n="title">Управление категориями магазина — Boostore.pro</span></h1>
...
// ===================================================================
// _get-shop_categories.php — ЭКСПОРТ (получение категорий с API)
// ===================================================================
if ($action === 'get'):
@set_time_limit(300);
...
<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><title>Импорт категорий — Boostore.pro</title>
...
<?php echo $header; ?>
<div class="plaque">
<span data-i18n="plaque_import">▸ <strong>Настройки импорта</strong> — получение категорий с API</span>
...
<div class="card">
<div class="form-row"><div class="field" style="max-width:150px;"><label data-i18n="per_page_import">Категорий за запрос</label><input type="number" name="per_page" value="<?=$getPerPage?>" min="1" max="2000"></div>
...
<div class="card">
  <h3 style="margin:0 0 10px;font-size:15px;color:#4dc9f6;" data-i18n="fix_import_title">🔧 Синхронизация полей категории</h3>
  <p style="font-size:11px;color:#888;margin-bottom:10px;" data-i18n="fix_import_desc">Синхронизировать поля с эталонной категорияом (по slug) после сохранения</p>
  <div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:8px;">
    <div>
      <label style="font-size:11px;color:#888;display:block;margin-bottom:3px;" data-i18n="ref_lang_label">🌐 Язык эталонной категории</label>
...
var _t={ru:{'home':'🏠 Главная','site_label':'Сайт:','entity_name':'Категории','import':'📥 Импорт','export':'📤 Экспорт','completed':'✓ Результат','result_label':'✓ Результат','created_label':'✅ Создано:','updated_label':'📝 Обновлено:','errors_label':'❌ Ошибок:','skipped_exist_label':'⏭ Пропущено (существуют):','skipped_exist_label2':'⏭ Пропущено','export_text_only':'📝 Экспортировать только текст','file_selection':'📁 Выбор файлов','btn_get':'📥 СКАЧАТЬ','btn_update':'📤 ОТПРАВИТЬ','plaque_import':'▸ <strong>Настройки импорта</strong> — получение категорий с API','plaque_export':'▸ <strong>Настройки экспорта</strong> — отправка категорий на Boostore.pro','search_import':'Поиск по имени (slug)','cat_filter':'📂 Категории для фильтрации','cat_note':'Если не выбрано ни одной — обрабатываются все категории.','back_home':'← Назад','btn_more':'+ ЕЩЕ','btn_more_multi':'📋 ЕЩЕ НЕСКОЛЬКО','btn_add_cat':'+ Добавить категорию','per_page_import':'Категорий за запрос','date_from':'Дата с','date_to':'Дата по','lang_label':'Язык','id_min_label':'ID >','id_max_label':'ID <','id_min_placeholder':'1000','id_max_placeholder':'5000','folder_planned_chk':'Разделять planned в <code>products/planned/</code>','folder_category_chk':'Разделять по папкам категорий','all_languages':'все','lang_ru':'Русский','lang_en':'English','lang_ua':'Українська','lang_pl':'Polski','lang_de':'Deutsch','lang_fr':'Français','lang_es':'Español','lang_it':'Italiano','lang_kk':'Қазақ','lang_be':'Беларуская','api_docs':'API Docs','version':'v2.0','date_format':'ГГГГ-ММ-ДД','search_placeholder':'часть имени, например: shoes','cat_id_placeholder':'ID','cat_name_placeholder':'имя категории','prompt_values':'Введите значения (каждая строка — отдельное поле):','step_forward':'➡ ДАЛЕЕ','dry_run_label':'Dry run','filter_name':'Фильтр по имени (slug)','batch_label':'Отправить за 1 раз','ref_lang_be':'Белорусский (be)','ref_lang_en':'English (en)','ref_lang_ru':'Русский (ru)','ref_lang_ua':'Українська (ua)','ref_lang_pl':'Polski (pl)','date_mode_meta':'Из мета-данных (дата из каждого категории)','date_mode_fixed':'Одна дата для всех категорий','date_mode_offset':'Смещение дат (+N дней на категория)','planned_notset':'— не указано (из мета-данных)','planned_0':'0 — не отложенная','planned_1':'1 — отложенная публикация','status_mode_meta':'Из мета-данных (статус из каждого категории)','status_mode_override':'Переопределить для всех категорий','date_mode_label':'📅 Режим даты публикации','title':'Управление категориями магазина — Boostore.pro','fix_import_title':'🔧 Исправление по эталону','fix_import_desc':'Синхронизировать поля с эталонной категорией (по slug) после сохранения','ref_lang_label':'🌐 Язык эталонной категории','export_fields_label':'📋 Поля для экспорта','export_category_id_label':'ID категорії','export_product_id_label':'Product ID','export_category_name_label':'Имя категории','import_only_named':'Только с именем'},en:{'home':'🏠 Home','site_label':'Site:','entity_name':'Categories','import':'📥 Import','export':'📤 Export','completed':'✓ Completed','result_label':'✓ Result','created_label':'✅ Created:','updated_label':'📝 Updated:','errors_label':'❌ Errors:','skipped_exist_label':'⏭ Skipped (exist):','skipped_exist_label2':'⏭ Skipped','export_text_only':'📝 Export text only','file_selection':'📁 File selection','btn_get':'📥 DOWNLOAD','btn_update':'📤 UPLOAD','plaque_import':'▸ <strong>Import Settings</strong> — fetching products from API','plaque_export':'▸ <strong>Export Settings</strong> — sending products to Boostore.pro','search_import':'Search by name (slug)','cat_filter':'📂 Categories for filtering','cat_note':'If none selected, all categories are processed.','back_home':'← Back','btn_more':'+ MORE','btn_more_multi':'📋 ADD MULTIPLE','btn_add_cat':'+ Add Category','per_page_import':'Products per request','date_from':'Date from','date_to':'Date to','lang_label':'Language','folder_planned_chk':'Separate planned into <code>products/planned/</code>','folder_category_chk':'Separate by category folders','all_languages':'all','lang_ru':'Russian','lang_en':'English','lang_ua':'Ukrainian','lang_pl':'Polish','lang_de':'German','lang_fr':'French','lang_es':'Spanish','lang_it':'Italian','lang_kk':'Kazakh','lang_be':'Belarusian','api_docs':'API Docs','version':'v2.0','date_format':'YYYY-MM-DD','search_placeholder':'part of name, e.g.: shoes','cat_id_placeholder':'ID','cat_name_placeholder':'category name','prompt_values':'Enter values (each line is a separate field):','step_forward':'➡ NEXT','dry_run_label':'Dry run','filter_name':'Filter by name (slug)','batch_label':'Send per run','ref_lang_be':'Belarusian (be)','ref_lang_en':'English (en)','ref_lang_ru':'Russian (ru)','ref_lang_ua':'Ukrainian (ua)','ref_lang_pl':'Polish (pl)','date_mode_meta':'From meta-data (date from each article)','date_mode_fixed':'Single date for all products','date_mode_offset':'Date offset (+N days per article)','planned_notset':'— not set (from meta-data)','planned_0':'0 — not planned','planned_1':'1 — planned publishing','status_mode_meta':'From meta-data (status from each article)','status_mode_override':'Override for all products','date_mode_label':'📅 Publication Date Mode','title':'Shop Category Management — Boostore.pro','fix_import_title':'🔧 Fix by Reference','fix_import_desc':'Sync fields with reference category (by slug) after save','ref_lang_label':'🌐 Reference Language','export_fields_label':'📋 Fields to export','export_category_id_label':'Category ID','export_product_id_label':'Product ID','export_category_name_label':'Category name','import_only_named':'Named only'},ua:{'home':'🏠 Головна','site_label':'Сайт:','entity_name':'Категорії','import':'📥 Імпорт','export':'📤 Експорт','completed':'✓ Результат','result_label':'✓ Результат','created_label':'✅ Створено:','updated_label':'📝 Оновлено:','errors_label':'❌ Помилок:','skipped_exist_label':'⏭ Пропущено (існують):','skipped_exist_label2':'⏭ Пропущено','export_text_only':'📝 Експортувати тільки текст','file_selection':'📁 Вибір файлів','btn_get':'📥 ПОЧАТИ ІМПОРТ','btn_update':'📤 ПОЧАТИ ЕКСПОРТ','plaque_import':'▸ <strong>Налаштування імпорту</strong> — отримання категорий з API','plaque_export':'▸ <strong>Налаштування експорту</strong> — відправлення категорий на Boostore.pro','search_import':'Пошук за іменем (slug)','cat_filter':'📂 Категорії для фільтрації','cat_note':'Якщо не вибрано жодної — обробляються всі категорії.','back_home':'← На головну','btn_more':'+ ЩЕ','btn_more_multi':'📋 ДОДАТИ КІЛЬКА','btn_add_cat':'+ Додати категорію','per_page_import':'Статей за запит','date_from':'Дата з','date_to':'Дата по','lang_label':'Мова','folder_planned_chk':'Розділяти planned у <code>products/planned/</code>','folder_category_chk':'Розділяти по папках категорій','all_languages':'всі','lang_ru':'Російська','lang_en':'Англійська','lang_ua':'Українська','lang_pl':'Польська','lang_de':'Німецька','lang_fr':'Французька','lang_es':'Іспанська','lang_it':'Італійська','lang_kk':'Казахська','lang_be':'Білоруська','api_docs':'API Docs','version':'v2.0','date_format':'РРРР-ММ-ДД','search_placeholder':'частина імені, наприклад: shoes','cat_id_placeholder':'ID','cat_name_placeholder':'ім\'я категорії','prompt_values':'Введіть значення (кожен рядок — окреме поле):','step_forward':'➡ ДАЛІ','dry_run_label':'Dry run','filter_name':'Фільтр за іменем (slug)','batch_label':'Відправити за 1 раз','ref_lang_be':'Білоруська (be)','ref_lang_en':'Англійська (en)','ref_lang_ru':'Російська (ru)','ref_lang_ua':'Українська (ua)','ref_lang_pl':'Польська (pl)','date_mode_meta':'З мета-даних (дата з кожної статті)','date_mode_fixed':'Одна дата для всіх категорий','date_mode_offset':'Зміщення дат (+N днів на статтю)','planned_notset':'— не вказано (з мета-даних)','planned_0':'0 — не відкладена','planned_1':'1 — відкладена публікація','status_mode_meta':'З мета-даних (статус з кожної статті)','status_mode_override':'Перевизначити для всіх категорий','date_mode_label':'📅 Режим дати публікації','title':'Керування категоріями магазину — Boostore.pro','fix_import_title':'🔧 Виправлення за еталоном','fix_import_desc':'Синхронізувати поля з еталонною категорією (по slug) після збереження','ref_lang_label':'🌐 Мова еталонної категорії','export_fields_label':'📋 Поля для експорту','export_category_id_label':'ID категорії','export_product_id_label':'ID товару','export_category_name_label':'Ім\'я категорії','import_only_named':'Тільки з назвою'}};
...
if (!empty($categories) && !$fetchError) {
    ...
    if (!empty($getSearch)) {
        $categories = array_filter($categories, function($cat) use ($getSearch) {
            $n = $cat['category_name'] ?? $cat['category_title'] ?? '';
    ...
    if ($idMinGet > 0 || $idMaxGet > 0) {
        $categories = array_filter($categories, function($cat) use ($idMinGet, $idMaxGet) {
            $aid = (int)($cat['category_id'] ?? 0);
    ...
    foreach ($categories as $a) {
        $catId = (int)($a['category_parent_id'] ?? 0);
        $categoryName = $a['category_name'] ?? '';
$id = (int)($a['category_id'] ?? 0); $name = $a['category_name'] ?? '';
$slug = $a['category_name'] ?? ''; $language = $a['category_lang'] ?? 'ru';
...
if ($importOnlyNamed && trim($name) === '') { $skipped++; continue; }
        $title = $a['category_title_inpage'] ?? $a['category_title'] ?? '';
        $metaTitle = $a['category_title_seo_append'] ?? '';
        $metaDesc = $a['category_meta_d'] ?? '';
        $metaKeywords = $a['category_meta_k'] ?? '';
        $description = $a['category_description_seo_append'] ?? '';
        $shortDesc = $a['category_button'] ?? '';
        $status = (int)($a['category_access'] ?? 0);
        $priority = (int)($a['category_position']??0);
        $subdomain = (int)($a['subdomain']??0);
        $view = (int)($a['category_view']??0);
        $settingsComments = $a['category_settings_comments']??'';
        $settingsTags = (int)($a['category_settings_tags']??0);
        $comments = (int)($a['category_comments']??0);
        $settingsRating = (int)($a['category_settings_rating']??0);
        $showTree = (int)($a['category_show_tree']??0);
        $showPeriod = (int)($a['category_show_period']??0);
        $rating = (int)($a['category_rating']??0);
        $datestamp = $a['category_datestamp']??'';
        $multilangid = $a['category_multilangid']??''; $tags = $a['tags']??'';
        $categoryVisible = (int)($a['category_visible']??1);
        $categoryText = $a['category_text'] ?? '';
        $categoryImage = $a['category_image'] ?? '';
        $categoryButton = $a['category_button'] ?? '';
        $categoryShowTree = (int)($a['category_show_tree']??0);
        $categorySettingsChild = (int)($a['category_settings_childproductshow']??0);
        $categorySettingsStyle = (int)($a['category_settings_style']??0);
        $categorySettingsSibling = (int)($a['category_settings_sibling']??0);
        $categoryGooglegoodsCatid = (int)($a['category_googlegoods_catid']??0);
        $categoryPromuaCatid = (int)($a['category_promua_catid']??0);
        $categoryRozetkauaTitle = $a['category_rozetkaua_title']??'';
        $categoryMerchantProductCategory = $a['category_merchant_product_category']??'';
        $categoryGmProductType = $a['category_gm_product_type']??'';
        $categoryGmSizetype = (int)($a['category_gm_sizetype']??0);
        $categoryPriceappendRozetka = $a['category_priceappend_rozetka']??'';
        $categoryPriceappendPromua = $a['category_priceappend_promua']??'';
        $categoryImageSettings = (int)($a['category_image_settings']??0);
        $categoryCountProducts = (int)($a['category_count_products']??0);
        $categoryCountSubcategories = (int)($a['category_count_subcategories']??0);
        $categoryLevel = (int)($a['category_level']??0);
        $categoryTree = $a['category_tree']??'';
        $categoryTextPosition = (int)($a['category_text_position']??0);
        $categoryAuthor = (int)($a['category_author']??0);
        $categoryShowInlist = (int)($a['category_visible']??0);
        $subDir = '';
...
$filename = $id.($safeName!==''?'-'.$safeName:'').'-'.$language.'.html';
        ...
        $metaList = [
            'id'=>$id,'category_id'=>$id,'name'=>$name,'slug'=>$slug,'category_name'=>$categoryName,
            'category_title'=>$title,'category_lang'=>$language,'category_parent_id'=>$catId,
            'category_visible'=>$categoryVisible,'category_show_tree'=>$categoryShowTree,
            'category_access'=>$status,'category_position'=>$priority,
            'category_view'=>$view,'category_rating'=>$rating,'category_multilangid'=>$multilangid,
            'category_image'=>$categoryImage,'category_image_settings'=>$categoryImageSettings,
            'category_level'=>$categoryLevel,'category_tree'=>$categoryTree,
            'category_text_position'=>$categoryTextPosition,
            'category_count_products'=>$categoryCountProducts,'category_count_subcategories'=>$categoryCountSubcategories,
            'category_title_inpage'=>$title,'category_title_seo_append'=>$metaTitle,
            'category_description_seo_append'=>$description,'category_meta_d'=>$metaDesc,
            'category_meta_k'=>$metaKeywords,
            'category_settings_comments'=>$settingsComments,'category_settings_tags'=>$settingsTags,
            'category_comments'=>$comments,'category_settings_rating'=>$settingsRating,
            'category_settings_childproductshow'=>$categorySettingsChild,
            'category_settings_style'=>$categorySettingsStyle,'category_settings_sibling'=>$categorySettingsSibling,
            'category_googlegoods_catid'=>$categoryGooglegoodsCatid,
            'category_promua_catid'=>$categoryPromuaCatid,'category_rozetkaua_title'=>$categoryRozetkauaTitle,
            'category_merchant_product_category'=>$categoryMerchantProductCategory,
            'category_gm_product_type'=>$categoryGmProductType,'category_gm_sizetype'=>$categoryGmSizetype,
            'category_priceappend_rozetka'=>$categoryPriceappendRozetka,
            'category_priceappend_promua'=>$categoryPriceappendPromua,
            'category_author'=>$categoryAuthor,'tags'=>$tags,
        ...
        $h .= '<!-- CATEGORY TEXT BELOW -->'."\n".$categoryText."\n";
        $h .= '<!-- CATEGORY BUTTON BELOW -->'."\n".$shortDesc."\n";
        file_put_contents($filepath,$h); $saved++;
        $savedProducts[] = ['id'=>$id,'language'=>$language,'path'=>$relPath,'title'=>$title,'slug'=>$slug,
            'category'=>$categoryName,'status'=>$status,'descLen'=>mb_strlen($categoryText),
...
?><!DOCTYPE html>
<html lang="ru">
<head><meta charset="UTF-8"><title>Импорт категорий — Boostore.pro</title>
<style>
...
<h1 data-i18n="import_results_title">▸ Импорт категорий — получено с API</h1>
<?php if ($fetchError): ?>
...
<div class="card" style="display:flex;gap:8px;align-items:center;margin-bottom:26px;flex-wrap:wrap;padding:10px;">
  ...
  <?php endif; ?>
  <span style="font-size:11px;color:#555;"><span data-i18n="per_page_by">по</span> <?=$perPage?> <span data-i18n="products_count">категорий</span>, <span data-i18n="all_total">всего</span> <?=$totalItems?></span>
</div>
<?php endif; ?>
<?php if($fixes):?>
...
<div style="font-size:12px;color:#e0e0e0;margin-bottom:8px;">Категории одной группы (одинаковый slug) имеют разный размер описания (расхождение > 50%):</div>
<table style="width:100%;font-size:12px;border-collapse:collapse;"><tr style="color:#ff9800;"><th style="padding:4px 8px;text-align:left;">slug</th><th style="padding:4px 8px;text-align:left;">мин</th><th style="padding:4px 8px;text-align:left;">макс</th><th style="padding:4px 8px;text-align:left;">категории</th></tr>
...
<?php endforeach;?>
<div class="footer"><strong>Boostore.pro</strong> — <span data-i18n="import_complete">Импорт категорий завершён</span></div>
<script>
(function(){
...
<?php exit;
// ===================================================================
// _get-shop_categories.php — END
// ===================================================================
endif;

// ===================================================================
// _update-shop_categories.php — ИМПОРТ (отправка категорий на API)
// ===================================================================
if ($action === 'update'):
...
if ($expDateMode === 'offset' && $expDateOffsetBase !== '' && $expDateOffsetDays > 0) {
    ...
    if ($baseTs) {
        $catDir2 = $CATEGORIES_DIR;
        if (is_dir($catDir2)) {
            $rdi2 = new RecursiveDirectoryIterator($catDir2,RecursiveDirectoryIterator::SKIP_DOTS);
...
?><!DOCTYPE html>
<html lang="ru">
<head><meta charset="UTF-8"><title>Экспорт категорий — Boostore.pro</title>
<style>
*{margin:0;padding:0;box-sizing:border-box}body{background:#1a1a2e;color:#e0e0e0;font-family:'Segoe UI',system-ui,sans-serif;padding:30px}.wrap{max-width:1200px;margin:0 auto}
...
<body><div class="wrap"><?php echo $header; ?>
<div class="plaque">
<span data-i18n="plaque_export">▸ <strong>Настройки экспорта</strong> — отправка категорий на Boostore.pro</span>
<span><a href="?site=<?=urlencode($currentSite)?>" style="padding:6px 16px;background:transparent;color:#00d4ff;border:1px solid #00d4ff;border-radius:4px;text-decoration:none;font-size:13px;" data-i18n="back_home">← Назад</a></span>
</div>
...
<script>
var _lang='ru';try{_lang=localStorage.getItem('boostore_lang')||navigator.language.slice(0,2);localStorage.setItem('boostore_lang',_lang);}catch(e){}if(!['ru','en','ua'].includes(_lang))_lang='ru';
var _t={ru:{'home':'🏠 Главная','site_label':'Сайт:','entity_name':'Категории','import':'📥 Импорт','export':'📤 Экспорт','completed':'✓ Результат','result_label':'✓ Результат','created_label':'✅ Создано:','updated_label':'📝 Обновлено:','errors_label':'❌ Ошибок:','skipped_exist_label':'⏭ Пропущено (существуют):','skipped_exist_label2':'⏭ Пропущено','export_text_only':'📝 Экспортировать только текст','file_selection':'📁 Выбор файлов','filter_name':'Фильтр по имени (slug)','batch_label':'Отправить за 1 раз','lang_label':'Язык','step_forward':'➡ ДАЛЕЕ','back_home':'← Назад','dry_run_label':'Dry run','plaque_export':'▸ <strong>Настройки экспорта</strong> — отправка категорий на Boostore.pro','dryrun_warn':'⚡ DRY RUN — запросы не отправляются','btn_more':'+ ЕЩЕ','btn_more_multi':'📋 ЕЩЕ НЕСКОЛЬКО','prompt_values':'Введите значения (каждая строка — отдельное поле):','search_placeholder':'часть имени, например: shopify','all_languages':'все','date_mode_meta':'Из мета-данных (дата из каждого категории)','date_mode_fixed':'Одна дата для всех категорий','date_mode_offset':'Смещение дат (+N дней на категория)','date_fixed_label':'📅 Фиксированная дата','date_offset_label':'📅 Базовая дата','date_offset_days':'+ дней на статью','override_planned':'📅 Переопределить planned','planned_notset':'— не указано (из мета-данных)','planned_0':'0 — не отложенная','planned_1':'1 — отложенная публикация','status_mode_label':'🔒 Статус доступа (status)','status_mode_meta':'Из мета-данных (статус из каждого категории)','status_mode_override':'Переопределить для всех категорий','status_value_label':'Значение статуса','status_published':'1 — опубликовано (доступно)','status_hidden':'0 — скрыто (недоступно)','mode_label':'🔄 Режим экспорта','mode_all':'Добавление + обновление','mode_insert':'Только добавление новых','mode_update':'Только обновление существующих','fix_export_title':'🔧 Исправление при экспорте','fix_export_desc':'Синхронизировать поля с эталонной категорией (по slug) при экспорте','date_mode_label':'📅 Режим даты публикации','title':'Управление категориями магазина — Boostore.pro','fix_import_title':'🔧 Исправление по эталону','fix_import_desc':'Синхронизировать поля с эталонной категорией (по slug) после сохранения','ref_lang_label':'🌐 Язык эталонной категории','export_fields_label':'📋 Поля для экспорта','export_category_id_label':'ID категорії','export_product_id_label':'Product ID','export_category_name_label':'Имя категории','import_only_named':'Только с именем'},en:{'home':'🏠 Home','site_label':'Site:','entity_name':'Categories','import':'📥 Import','export':'📤 Export','completed':'✓ Completed','result_label':'✓ Result','created_label':'✅ Created:','updated_label':'📝 Updated:','errors_label':'❌ Errors:','skipped_exist_label':'⏭ Skipped (exist):','skipped_exist_label2':'⏭ Skipped','export_text_only':'📝 Export text only','file_selection':'📁 File selection','filter_name':'Filter by name (slug)','batch_label':'Send per run','lang_label':'Language','id_min_label':'ID >','id_max_label':'ID <','id_min_placeholder':'1000','id_max_placeholder':'5000','step_forward':'➡ NEXT','back_home':'← Back','dry_run_label':'Dry run','plaque_export':'▸ <strong>Export Settings</strong> — sending products to Boostore.pro','dryrun_warn':'⚡ DRY RUN — no API calls sent','btn_more':'+ MORE','btn_more_multi':'📋 ADD MULTIPLE','prompt_values':'Enter values (each line is a separate field):','search_placeholder':'part of name, e.g.: shopify','all_languages':'all','date_mode_meta':'From meta-data (date from each article)','date_mode_fixed':'Single date for all products','date_mode_offset':'Date offset (+N days per article)','date_fixed_label':'📅 Fixed Date','date_offset_label':'📅 Base Date','date_offset_days':'+ days per article','override_planned':'📅 Override planned','planned_notset':'— not set (from meta-data)','planned_0':'0 — not planned','planned_1':'1 — planned publishing','status_mode_label':'🔒 Access Status (status)','status_mode_meta':'From meta-data (status from each article)','status_mode_override':'Override for all products','status_value_label':'Status Value','status_published':'1 — published (public)','status_hidden':'0 — hidden (private)','mode_label':'🔄 Export mode','mode_all':'Add + Update','mode_insert':'Add new only','mode_update':'Update existing only','fix_export_title':'🔧 Fix on Export','fix_export_desc':'Sync fields with reference category (by slug) on export','date_mode_label':'📅 Publication Date Mode','title':'Shop Category Management — Boostore.pro','fix_import_title':'🔧 Fix by Reference','fix_import_desc':'Sync fields with reference category (by slug) after save','ref_lang_label':'🌐 Reference Language','export_fields_label':'📋 Fields to export','export_category_id_label':'Category ID','export_product_id_label':'Product ID','export_category_name_label':'Category name','import_only_named':'Named only'},ua:{'home':'🏠 Головна','site_label':'Сайт:','entity_name':'Категорії','import':'📥 Імпорт','export':'📤 Експорт','completed':'✓ Результат','result_label':'✓ Результат','created_label':'✅ Створено:','updated_label':'📝 Оновлено:','errors_label':'❌ Помилок:','skipped_exist_label':'⏭ Пропущено (існують):','skipped_exist_label2':'⏭ Пропущено','export_text_only':'📝 Експортувати тільки текст','file_selection':'📁 Вибір файлів','filter_name':'Фільтр за іменем (slug)','batch_label':'Відправити за 1 раз','lang_label':'Мова','step_forward':'➡ ДАЛІ','back_home':'← На головну','dry_run_label':'Dry run','plaque_export':'▸ <strong>Налаштування експорту</strong> — відправлення категорий на Boostore.pro','dryrun_warn':'⚡ DRY RUN — запити не надсилаються','btn_more':'+ ЩЕ','btn_more_multi':'📋 ДОДАТИ КІЛЬКА','prompt_values':'Введіть значення (кожен рядок — окреме поле):','search_placeholder':'частина імені, наприклад: shopify','all_languages':'всі','date_mode_meta':'З мета-даних (дата з кожної статті)','date_mode_fixed':'Одна дата для всіх категорий','date_mode_offset':'Зміщення дат (+N днів на статтю)','date_fixed_label':'📅 Фіксована дата','date_offset_label':'📅 Базова дата','date_offset_days':'+ днів на статтю','override_planned':'📅 Перевизначити planned','planned_notset':'— не вказано (з мета-даних)','planned_0':'0 — не відкладена','planned_1':'1 — відкладена публікація','status_mode_label':'🔒 Статус доступу (status)','status_mode_meta':'З мета-даних (статус з кожної статті)','status_mode_override':'Перевизначити для всіх категорий','status_value_label':'Значення статусу','status_published':'1 — опубліковано (доступно)','status_hidden':'0 — приховано (недоступно)','mode_label':'🔄 Режим експорту','mode_all':'Додавання + оновлення','mode_insert':'Тільки додавання нових','mode_update':'Тільки оновлення існуючих','fix_export_title':'🔧 Виправлення при експорті','fix_export_desc':'Синхронізувати поля з еталонною категорією (по slug) при експорті','date_mode_label':'📅 Режим дати публікації','title':'Керування категоріями магазину — Boostore.pro','fix_import_title':'🔧 Виправлення за еталоном','fix_import_desc':'Синхронізувати поля з еталонною категорією (по slug) після збереження','ref_lang_label':'🌐 Мова еталонної категорії','export_fields_label':'📋 Поля для експорту','export_category_id_label':'ID категорії','export_product_id_label':'ID товару','export_category_name_label':'Ім\'я категорії','import_only_named':'Тільки з назвою'}};
function applyLang(l){try{localStorage.setItem('boostore_lang',l);}catch(e){}_lang=l;document.querySelectorAll('[data-i18n]').forEach(function(el){var key=el.getAttribute('data-i18n');if(_t[l]&&_t[l][key]!==undefined)el.innerHTML=_t[l][key];});document.querySelectorAll('[data-i18n-placeholder]').forEach(function(el){var key=el.getAttribute('data-i18n-placeholder');if(_t[l]&&_t[l][key]!==undefined)el.placeholder=_t[l][key];});}
if(_lang!='ru'){document.addEventListener('DOMContentLoaded',function(){applyLang(_lang);});}
document.addEventListener('DOMContentLoaded',function(){var ls=document.getElementById('lang_switcher');if(ls){ls.value=_lang;ls.addEventListener('change',function(){applyLang(this.value);});}});
</script>
...
<form method="get" action="?" id="export-step1" style="display:flex;flex-direction:column;gap:12px;">
  ...
  <div style="display:flex;gap:12px;align-items:flex-end;flex-wrap:wrap;">
    <div>
      ...
      <select name="date_mode" id="exp_date_mode" onchange="toggleExpDateFields()" style="padding:6px 8px;border:1px solid #0f3460;border-radius:4px;background:#16213e;color:#e0e0e0;">
        <option value=""<?=($_GET['date_mode']??$DATE_MODE)===''?' selected':''?> data-i18n="date_mode_meta">Из мета-данных (дата из каждого категории)</option>
        <option value="fixed"<?=($_GET['date_mode']??$DATE_MODE)==='fixed'?' selected':''?> data-i18n="date_mode_fixed">Одна дата для всех категорий</option>
        <option value="offset"<?=($_GET['date_mode']??$DATE_MODE)==='offset'?' selected':''?> data-i18n="date_mode_offset">Смещение дат (+N дней на категория)</option>
      </select>
    </div>
    ...
    <div id="exp_date_offset_days_block" style="display:<?=(($_GET['date_mode']??$DATE_MODE)==='offset')?'block':'none'?>;">
      <label style="font-size:11px;color:#888;display:block;margin-bottom:3px;" data-i18n="date_offset_days">+ дней на категория</label>
    ...
    <div>
      ...
      <select name="status_mode" id="exp_status_mode" onchange="toggleExpStatusFields()" style="padding:6px 8px;border:1px solid #0f3460;border-radius:4px;background:#16213e;color:#e0e0e0;">
        <option value=""<?=($_GET['status_mode']??$STATUS_MODE)===''?' selected':''?> data-i18n="status_mode_meta">Из мета-данных (статус из каждого категории)</option>
        <option value="override"<?=($_GET['status_mode']??$STATUS_MODE)==='override'?' selected':''?> data-i18n="status_mode_override">Переопределить для всех категорий</option>
      </select>
    </div>
  ...
  <div>
    ...
    <div style="font-size:11px;color:#888;margin-bottom:8px;" data-i18n="fix_export_desc">Синхронизировать поля с эталонной категорияом (по slug) при экспорте</div>
    <div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:8px;">
      <div>
        <label style="font-size:11px;color:#888;display:block;margin-bottom:3px;" data-i18n="ref_lang_label">🌐 Язык эталонной категории</label>
  ...
  <div>
    ...
    <div style="display:flex;gap:12px;flex-wrap:wrap;">
      <label style="font-size:12px;color:#ccc;cursor:pointer;display:flex;align-items:center;gap:3px;">
        ...
        <input type="checkbox" name="export_product_id" value="1"<?=!empty($_GET['export_product_id'])?' checked':''?> data-i18n="export_product_id"> <span data-i18n="export_product_id_label">ID категории</span>
      </label>
      <label style="font-size:12px;color:#ccc;cursor:pointer;display:flex;align-items:center;gap:3px;">
...
$htmlFiles2 = array_filter($htmlFiles2, function($p) { return !in_array(basename($p), ['index.php','_setting_shop_categories.inc']); });
...
<!DOCTYPE html>
<html lang="ru">
<head><meta charset="UTF-8"><title data-i18n="step2_title">Экспорт категорий — выбор файлов</title>
...
function extractCategoryButton(string $html):string{
    foreach (['<!-- CATEGORY BUTTON BELOW -->'] as $sep) {
...
if (isset($_GET['files']) && is_array($_GET['files'])) {
    ...
    if(is_dir($catDir)){$rdi=new RecursiveDirectoryIterator($catDir,RecursiveDirectoryIterator::SKIP_DOTS);$rii=new RecursiveIteratorIterator($rdi);foreach($rii as $f){if($f->isFile()&&strtolower($f->getExtension())==='html')$htmlFiles[]=$f->getPathname();}sort($htmlFiles);}
    $htmlFiles=array_filter($htmlFiles,function($p){return!in_array(basename($p),['index.php','_setting_shop_categories.inc']);});
...
$metaKeywords=$meta['meta_keywords']??'';$slug=$meta['slug']??$meta['category_name']??'';$language=$meta['language']??$meta['category_lang']??'ru';
$categoryName=$meta['category_name']??('sitecreate_'.$language);$catId=(int)($meta['category_id']??0);$parentId=(int)($meta['category_parent_id']??0);
$shortDesc=extractCategoryButton($html);$status=$meta['status']??'';
...
$categoryVisible=(int)($meta['category_visible']??1);$categoryText=$meta['category_text']??'';$categoryImage=$meta['category_image']??'';
...
$categoryText=extractCategoryContent($html);
$payload=['category_name'=>$slug,'category_title'=>$title,'category_lang'=>$language,'category_parent_id'=>$parentId,'category_visible'=>$categoryVisible,'category_text'=>$categoryText,'category_image'=>$categoryImage,'category_meta_d'=>$metaDesc,'category_meta_k'=>$metaKeywords,'category_title_inpage'=>$title,'category_title_seo_append'=>$metaTitle,'category_description_seo_append'=>$metaKeywords,'category_button'=>$shortDesc,'category_settings_comments'=>$settingsComments,'category_settings_tags'=>$settingsTags,'category_comments'=>$comments,'category_settings_rating'=>$settingsRating,'category_password'=>$password,'category_view'=>$view,'category_rating'=>$rating,'category_datestamp'=>$datestamp,'category_multilangid'=>$multilangid,'tags'=>$tags,'subdomain'=>$subdomain,'slug'=>$slug];
...
$jsonPayload=json_encode($payload,JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT);$descSize=mb_strlen($categoryText);$metaCount=count($meta);
...
<details><summary data-i18n="description_title">📄 Description (полный текст)</summary><textarea readonly><?=htmlspecialchars($categoryText)?></textarea></details>
...
$batchJson = json_encode(['categories' => $batchPayloads], JSON_UNESCAPED_UNICODE);
...
elseif($httpCode>=200&&$httpCode<300&&is_array($respData)):
    ...
    } elseif (isset($respData['categories']) && is_array($respData['categories'])) {
        $batchResults = [$respData['categories']];
    } elseif (isset($respData['products']) && is_array($respData['products'])) {
        $batchResults = [$respData['products']];
    }
    // Map results by slug_search or category_name
    $resultMap = []; $resultIdx = 0;
    foreach ($batchResults as $br) {
        $slugFull = $br['slug_search'] ?? $br['category_name'] ?? '';
        if ($slugFull) { 
    ...
    foreach ($batchProducts as $baIdx => $ba):
        ...
        <?php if ($hasErrors || empty($art)): ?>
            ...
            <?php if(empty($art)):?><br><span>Нет ответа для данной категории</span><?php endif;?>
            </div>
            <?php endif; ?>
        <?php else: ?>
            <div class="result-ok"><span class="success" data-i18n="<?=$isAdded?'product_created':'product_updated'?>">✓ Категория <?=$action2?> (ID: <?=$respId?>)</span>
...
<?php exit;
// ===================================================================
// _update-shop_categories.php — END
// ===================================================================
endif;
...
function saveConfigFromPost($post) {
    ...
    $c .= "];\n";
    file_put_contents(__DIR__.'/_setting_shop_categories.inc', $c);
}
$saveSuccess = false;
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_config'])) {
    saveConfigFromPost($_POST);
    $saveSuccess = true;
    require __DIR__.'/_setting_shop_categories.inc';
...
<html lang="ru">
<head>
<meta charset="UTF-8"><title>Управление категориями — Boostore.pro</title>
<style>
...
<strong>Boostore.pro</strong> — Скрипты для <strong>экспорта</strong> (скачивания) и <strong>импорта</strong> (отправки) категорий каталога через Commerce API. Сайт: <strong><?=htmlspecialchars($currentSite)?></strong>
</div>
...
<li data-i18n="step3">Выберите категории категорий для работы</li>
<li data-i18n="step4">Нажмите <strong>"СКАЧАТЬ"</strong> — категории скачаются в папку <code><?=htmlspecialchars($currentSite)?>/products/</code></li>
<li data-i18n="step5">При получении категории одной группы (одинаковый slug) сверяются с эталонной версией (выбранный язык в конфигурации). <code>multilangid</code>, <code>stock_status</code>, <code>price</code>, <code>new</code>, <code>featured</code>, <code>promotion</code>, <code>price_old</code>, <code>status</code>, <code>datestamp</code> приводятся к эталону</li>
...
<div style="font-size:12px;color:#888;margin-top:8px;" data-i18n="dryrun_desc">Режим «тест» — проверяет какие категории будут отправлены, но сами запросы к API не выполняются.</div>
</div></div>
...
<hr><h3 data-i18n="cat_title">📂 Разрешённые категории</h3><p style="color:#888;font-size:12px;margin-bottom:10px;" data-i18n="cat_desc">Только категории этих категорий будут получены и отправлены. Если список пуст — обрабатываются все.</p>
...
<div style="font-size:12px;color:#888;margin-bottom:8px;" data-i18n="import_settings_desc">Параметры, влияющие на получение и сохранение категорий из API</div>
...
<h3 style="margin:12px 0 8px;font-size:14px;color:#888;" data-i18n="products_count_title">📥 Количество категорий</h3>
<div class="form-row"><div class="field" style="max-width:200px;">
<label data-i18n="per_page_label">Категорий за запрос (per_page)</label>
<div style="font-size:11px;color:#888;margin-bottom:6px;" data-i18n="per_page_desc">Сколько категорий загружать за 1 запрос к API. Максимум 2000</div>
<input type="number" name="PER_PAGE" value="<?=(int)($PER_PAGE??200)?>" min="1" max="2000">
</div></div>
<h3 style="margin:12px 0 8px;font-size:14px;color:#888;" data-i18n="fix_export_title">🔧 Синхронизация полей категории</h3>
<div class="form-row"><div class="field" style="max-width:250px;">
<label data-i18n="ref_lang_label">🌐 Язык эталонной категории</label>
<div style="font-size:11px;color:#888;margin-bottom:6px;" data-i18n="ref_lang_desc">Категории этого языка считаются эталоном. При получении категории других языков сверяются с ним</div>
...
<div style="font-size:12px;color:#888;margin-bottom:8px;" data-i18n="export_settings_desc">Параметры, влияющие на отправку категорий на сайт</div>
<div class="form-row"><div class="field" style="max-width:400px;">
<label data-i18n="date_mode_label">📅 Режим даты публикации</label>
<div style="font-size:11px;color:#888;margin-bottom:6px;" data-i18n="date_mode_desc">Как определять дату публикации категорий при импорте</div>
<select name="DATE_MODE" id="date_mode" onchange="toggleDateFields()">
<option value=""<?=$DATE_MODE===''?' selected':''?> data-i18n="date_mode_meta">Из мета-данных (дата из каждого категории)</option>
<option value="fixed"<?=$DATE_MODE==='fixed'?' selected':''?> data-i18n="date_mode_fixed">Одна дата для всех категорий</option>
<option value="offset"<?=$DATE_MODE==='offset'?' selected':''?> data-i18n="date_mode_offset">Смещение дат (+N дней на категория)</option>
</select>
</div></div>
...
<div style="font-size:11px;color:#888;margin-bottom:6px;" data-i18n="date_fixed_desc">Эта дата будет установлена всем категориям</div>
...
<div style="font-size:11px;color:#888;" data-i18n="date_offset_desc">Первая уникальная категория (по slug) получит базовую дату, вторая — базовую дату + N дней, и т.д. Категории на разных языках с одинаковым slug считаются одной категорияом и получают одинаковую дату.</div>
</div>
<script>
...
<div style="font-size:11px;color:#888;margin-bottom:6px;" data-i18n="status_mode_desc">Режим определения статуса публикации категорий при импорте</div>
<select name="STATUS_MODE" id="status_mode" onchange="toggleStatusFields()">
<option value=""<?=$STATUS_MODE===''?' selected':''?> data-i18n="status_mode_meta">Из мета-данных (статус из каждого категории)</option>
<option value="override"<?=$STATUS_MODE==='override'?' selected':''?> data-i18n="status_mode_override">Переопределить для всех категорий</option>
</select>
</div></div>
...
<div style="font-size:11px;color:#888;margin-bottom:6px;" data-i18n="send_limit_desc">Сколько категорий можно отправить за один запуск. Максимум 5000</div>
...
<div style="font-size:11px;color:#888;margin-bottom:8px;" data-i18n="fix_desc">Какие поля автоматически исправлять по эталону при получении категорий</div>
...
<div class="footer"><strong>Boostore.pro</strong> — <span data-i18n="footer_text">Управление категориими каталога</span> &nbsp;|&nbsp; <a href="https://boostore.pro/ru/docs/api-integration/#hotengine-CommerceAPI" target="_blank" data-i18n="footer_docs">Документация API</a> &nbsp;|&nbsp; <a href="index.php" style="color:#00d4ff;" data-i18n="back_home">← На главную</a></div>
</div>
<script>
// ===== i18n Translations =====
var i18n = {
  ru: {
    'title':'Управление категориями магазина — Boostore.pro',
    ...
    'plaque':'Boostore.pro — Скрипты для экспорта (скачивания) и импорта (отправки) категорий каталога через Commerce API. Домен: ',
    'plaque_import':'▸ <strong>Настройки импорта</strong> — получение категорий с API',
    'plaque_export':'▸ <strong>Настройки экспорта</strong> — отправка категорий на Boostore.pro',
    ...
    'step3':'Выберите категории категорий для работы',
    'step4':'Нажмите «ПОЛУЧИТЬ СТАТЬИ» — категории скачаются в папку products/',
    'step5':'При получении категории одной группы (одинаковый slug) сверяются с эталонной версией (выбранный язык в конфигурации). multilangid, stock_status, price, new, featured, promotion, price_old, status, datestamp приводятся к эталону',
    ...
    'dryrun_desc':'Режим «тест» — проверяет какие категории будут отправлены, но сами запросы к API не выполняются.',
    ...
    'cat_desc':'Только категории этих категорий будут получены и отправлены. Если список пуст — обрабатываются все.',
    'footer_text':'Управление категориями блога',
    'footer_docs':'Документация API',
    'confirm_get':'Запустить получение категорий?',
    'confirm_update':'Запустить отправку категорий?',
    ...
    'date_mode_meta':'Из мета-данных (дата из каждого категории)',
    'date_mode_fixed':'Одна дата для всех категорий',
    'date_mode_offset':'Смещение дат (+N дней на категория)',
    'planned_notset':'— не указано (из мета-данных)',
    'planned_0':'0 — не отложенная',
    'planned_1':'1 — отложенная публикация',
    'status_mode_meta':'Из мета-данных (статус из каждого категории)',
    'status_mode_override':'Переопределить для всех категорий',
    'export_settings_title':'📤 Настройки экспорта',
    'export_settings_desc':'Параметры, влияющие на получение и сохранение категорий из API',
    ...
    'products_count_title':'📥 Количество категорий',
    'per_page_label':'Категорий за запрос (per_page)',
    'per_page_desc':'Сколько категорий загружать за 1 запрос к API. Максимум 2000',
    'fix_export_title':'🔧 Исправление при экспорте',
    'ref_lang_label':'🌐 Язык эталонной категории',
    'ref_lang_desc':'Категории этого языка считаются эталоном. При получении категории других языков сверяются с ним',
    'import_settings_title':'📥 Настройки импорта',
    'import_settings_desc':'Параметры, влияющие на отправку категорий на сайт',
    'date_mode_label':'📅 Режим даты публикации',
    'date_mode_desc':'Как определять дату публикации категорий при импорте',
    'date_fixed_label':'📅 Фиксированная дата',
    'date_fixed_desc':'Эта дата будет установлена всем категориям',
    'date_offset_label':'📅 Базовая дата (от которой начинать отсчёт)',
    'date_offset_days':'+ дней на статью',
    'date_offset_desc':'Первая уникальная категория (по slug) получит базовую дату, вторая — базовую дату + N дней, и т.д. Категории на разных языках с одинаковым slug считаются одной категорияом и получают одинаковую дату.',
    'override_planned':'📅 Переопределить planned',
    'override_planned_desc':'Если задать — будет применено ко ВСЕМ категориим при импорте. Пусто — брать из мета-данных каждого категории',
    'status_mode_label':'🔒 Статус доступа (status)',
    'status_mode_desc':'Режим определения статуса публикации категорий при импорте',
    ...
    'send_limit_desc':'Сколько категорий можно отправить за один запуск. Максимум 5000',
    'fix_title':'🔄 Исправление по эталону',
    'fix_desc':'Какие поля автоматически исправлять по эталону при получении категорий',
    'back_home':'Назад',
    'btn_more':'+ ЕЩЕ',
    'btn_more_multi':'📋 ЕЩЕ НЕСКОЛЬКО',
    'btn_add_cat':'+ Добавить категорию',
    'per_page_import':'Категорий за запрос',
    'date_from':'Дата с',
    'date_to':'Дата по',
    'lang_label':'Язык',
...
'home':'🏠 Home',
  ...
  ua: {
    ...
    'plaque':'Boostore.pro — Скрипти для експорту (завантаження) та імпорту (відправлення) категорий блогу через Commerce API. Домен: ',
    'plaque_import':'▸ <strong>Налаштування імпорту</strong> — отримання категорий з API',
    'plaque_export':'▸ <strong>Налаштування експорту</strong> — відправлення категорий на Boostore.pro',
    ...
    'step3':'Виберіть категорії категорий для роботи',
    ...
    'confirm_get':'Запустити отримання категорий?',
    'confirm_update':'Запустити відправлення категорий?',
    ...
    'date_mode_fixed':'Одна дата для всіх категорий',
    ...
    'status_mode_override':'Перевизначити для всіх категорий',
    'export_settings_title':'📤 Налаштування експорту',
    'export_settings_desc':'Параметри, що впливають на отримання та збереження категорий з API',
    'folder_structure':'📁 Структура папок',
    'folder_planned':'Розділяти planned у <code>products/planned/</code>',
    'folder_category':'Розділяти по папках категорій',
    'products_count_title':'📥 Кількість категорий',
    'per_page_label':'Статей за запит (per_page)',
    'per_page_desc':'Скільки категорий завантажувати за 1 запит до API. Максимум 2000',
    'fix_export_title':'🔧 Виправлення при експорті',
    'ref_lang_label':'🌐 Мова еталонної статті',
    'ref_lang_desc':'Статті цієї мови вважаються еталоном. При отриманні категорий іншими мовами звіряються з ним',
    'import_settings_title':'📥 Налаштування імпорту',
    'import_settings_desc':'Параметри, що впливають на відправлення категорий на сайт',
    'date_mode_label':'📅 Режим дати публікації',
    'date_mode_desc':'Як визначати дату публікації категорий при імпорті',
    'date_fixed_label':'📅 Фіксована дата',
    'date_fixed_desc':'Ця дата буде встановлена для всіх категорий',
    ...
    'override_planned_desc':'Якщо задано — застосовується до ВСІХ категорий при імпорті. Порожньо — брати з мета-даних кожної статті',
    'status_mode_label':'🔒 Статус доступу (status)',
    'status_mode_desc':'Режим визначення статусу публікації категорий при імпорті',
    ...
    'send_limit_desc':'Скільки категорий можна відправити за один запуск. Максимум 5000',
    'fix_title':'🔄 Виправлення за еталоном',
    'fix_desc':'Які поля автоматично виправляти за еталоном при отриманні категорий',
